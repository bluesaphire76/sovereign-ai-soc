...
INTENT_REGISTRY = (
    ...
    IntentDescriptor(
        ...
        (
            ...
            "Find other relevant incidents without assuming they share one attack.",
            "Other relevant incidents outside the current record.",
            ...
            "Trova altri incidenti rilevanti senza assumere lo stesso attacco.",
            "Altri incidenti rilevanti rispetto al record corrente.",
