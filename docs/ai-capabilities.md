...
The platform uses Ollama as the local LLM runtime. Runtime configuration is controlled through `.env` values such as `OLLAMA_MODEL` and `OLLAMA_BASE_URL`.

The Health page exposes AI runtime observability, including configured model and connectivity status where available.
...
## 10. Detection Quality Assistance
...
## 11. Executive Insights and Report Enrichment
...
## 12. Timeout, Fallback and Runtime Observability
...
## 14. What AI Does Not Do Automatically
