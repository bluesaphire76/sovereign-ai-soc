...
# The gateway contract remains the hard bound. V2 keeps its 768-token request
# default, while V3 may explicitly request a larger closed structured plan.
SOC_ASSISTANT_VISIBLE_MAX_TOKENS_MAX = 2048
